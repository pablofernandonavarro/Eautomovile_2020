                                ...
                                <div class="row ">
                                    ...
                                    <div class="form-check p-3">
                                        <label class="form-check-label p-2 ml-1">
                                            <input type="checkbox" checked class="form-check-input" name="color_id[]"
                                                id="" value="{{$color->id}} "
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    {!!$errors->first('supplier_product_code','<small
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <div class="col-md-12">
                                        {!!$errors->first('supplier_price_list','<small
                                            class="alert alert-danger col-md-12" role="alert">:message
                                        </small>')!!}
                                    </div>
                                    <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" type="number" id="price_discount"
                                            name="price_discount" step="any" min="0" max="100"
