            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="date" name="date_start" id="category_id" class="form-control " style="width: 100%;">

                  <div class="form-group">
                    <label>cantidad</label>
                    <input type="number" name="quantity" id="quantity" class="form-control " style="width: 100%;"
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input class="form-control" type="number" id="precioanterior" name="" min="0" value="0" step=".01">
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="progress">
                    <div id="barraprogreso" class="progress-bar" role="progressbar"
                      ...
                      aria-valuemax="100">@{{ porcentajededescuento }}%</div>
                  </div>
                </div>
                <!-- /.form-group -->
