                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="text" id="supplier_price_list"
                                        name="supplier_price_list" value="" dislable>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input class="form-control" type="number" id="supplier_discount"
                                        ...
                                        value="{{$products->suppliers->supplier_discount}}" disabled>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control" id="cost" name="cost" value="{{old('cost')}}" dislable>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input class="form-control" type="number" id="utility" name="utility" step="any" min="0"
                            max="100" value="{{old($product->utility)}}">
                        <div class="input-group-prepend">
                            <span class="input-group-text">%</span>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="number" id="discount_rate" name="discount_rate"
                                    step="any" min="0" max="100" value="{{$products->discount_rate}}" disabled>
                                <div class="input-group-prepend">
                                    <span class="input-group-text">%</span>
                                </div>
