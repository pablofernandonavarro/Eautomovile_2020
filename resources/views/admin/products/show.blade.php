                        ...
                        <div class="row">
                            ...
                            <div class="color col-md-6">
                                ...
                                <div class="pattern col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label>Modelo</label>
                                        <input name="pattern_id" id="pattern_id" class="form-control "
                                            style="width: 100%;" value="{{$products->pattern->pattern_name}}">
                                ...
                                <div class="category col-md-6">
                                    ...
                                    <input name="category_id" id="category_id" class="form-control "
                                        style="width: 100%;" value="{{$products->category->category_name}}">
                    ...
                    <div class="card card-warning">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{'/storage/'.$product->url_picture}}" alt="foto" width="300"
